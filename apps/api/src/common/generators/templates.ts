...
export const createInputDtoFile = (names) => {
...
export class FindMany${capital}Args
  implements Required<Omit<Prisma.${capital}FindManyArgs, 'include' | 'select'>>
{
...
export class ${capital}OrderByWithRelationInput
  implements Required<Prisma.${capital}OrderByWithRelationInput>
{
  // Todo: Add properties
...
export class ${capital}WhereUniqueInput
  implements Required<Prisma.${capital}WhereUniqueInput>
{
  @Field(() => Number, { nullable: true })
  id: number
}
...
@InputType()
export class ${capital}WhereInput implements Required<Prisma.${capital}WhereInput> {
...
@ObjectType()
export class ${capital} implements ${capital}Type {
